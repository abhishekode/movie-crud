    ...
    return (
        <div className="min-h-[88vh] p-4">
            <div className="container mx-auto">
                ...
                <h1 className="text-3xl md:text-5xl font-bold text-white py-28">Edit</h1>
                    ...
                    <div className="max-w-lg flex flex-col gap-4 w-full">
                        ...
                        <div className="flex space-x-4 mt-12">
                            <button
                                ...
                                className="flex-1 border-white text-white rounded-[10px] hover:bg-green-500 p-4 font-semibold border"
                            >
                                Cancel
                            </button>
                            <button
                                type="submit"
                                className="flex-1 bg-green-500 text-white rounded-md hover:bg-green-600 p-4 font-semibold"
                            >
